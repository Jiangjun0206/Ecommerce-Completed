                ...
                <div class="col-md-12">
                    <select class="selectpicker" data-live-search="true" name="category" data-toggle="tooltip" title="<?php echo translate('select');?>" onChange="set_search_by_cat(this);">
                        <option value="0"  data-cat="0" 
                            data-min="<?php echo round($this->crud_model->get_range_lvl_cproduct('customer_product_id !=', '0', "min")); ?>" 
                               data-max="<?php echo round($this->crud_model->get_range_lvl_cproduct('customer_product_id !=', '0', "max")); ?>" 
                        ...
                        <option value="<?php echo $row1['category_id']; ?>" 
                            data-cat="<?php echo $row1['category_id']; ?>" 
                                data-min="<?php echo round($this->crud_model->get_range_lvl_cproduct('category', $row1['category_id'], "min")); ?>" 
                                   data-max="<?php echo round($this->crud_model->get_range_lvl_cproduct('category', $row1['category_id'], "max")); ?>" 
            ...
            <div class="row">
                <!-- <div class="col-md-12">
                    <div class="widget widget-filter-price" style="padding: 2px 20px;height: 40px;">                
                        ...
                        <input type="hidden" id="univ_max" value="<?php echo $this->crud_model->get_range_lvl_cproduct('customer_product_id !=', '', "max"); ?>">
                    </div>
                </div> -->
                <div class="col-md-12">
